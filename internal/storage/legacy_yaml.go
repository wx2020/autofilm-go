...
func ImportLegacyYAML(s *Store, path string) (int, error) {
	...
	keys := map[string]string{"Alist2StrmList": "alist2strm", "Ani2AlistList": "ani2alist", "LibraryPosterList": "libraryposter", "AlistSyncList": "alistsync", "FileMoveList": "filemove"}
	imported := 0
